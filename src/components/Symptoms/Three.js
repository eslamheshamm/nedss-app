...
import SymptomsOfTheNervousAndMuscularSystem from "./SymptomsGroups/SymptomsOfTheNervousAndMuscularSystem";

const SymptomsThree = ({ navigation }) => {
	return (
		<ScrollView style={tw`bg-white  h-full`}>
			<View style={tw`mt-[80px]`}>
				<SymptomsOfTheNervousAndMuscularSystem />
			</View>
			<View
			...
			>
				...
				<TouchableOpacity
					style={tw` rounded-xl  bg-[#294374] text-white px-12 py-4 justify-center items-center  `}
					onPress={() => navigation.navigate("EighthStep")}
				>
